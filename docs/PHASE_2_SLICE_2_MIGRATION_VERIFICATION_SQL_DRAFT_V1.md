...
| Metric | Count |
|--------|------:|
| Block A unique check IDs (incl. `A-12-01`) | 73 |
| Block A rows in `all_a` (excl. summary) | 72 |
| Block A binding non-INFO checks in `all_a` | 67 |
